...
const Modal = ({ items }: ModalProps) => {
  ...
  return (
    <div className="w-screen min-h-screen flex flex-col items-center py-10">
      <div className="w-3/4">
        <h1 className="text-center text-2xl font-bold mb-10 pb-3 border-b-2 border-black">ご鑑賞に際してのお願い</h1>
      ...
      <button onClick={_onClick} className="bg-blue-900 text-white w-3/4 h-10 font-bold my-10">
        確認しました
      </button>
    </div>
  )
